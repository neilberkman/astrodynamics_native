...
https://github.com/neilberkman/astrodynamics_native/security/advisories/new
...
[Hex](https://hex.pm/packages/astrodynamics). Please upgrade to the latest version before
reporting an issue.
